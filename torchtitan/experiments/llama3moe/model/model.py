...
from torchtitan.models.flash_attention_triton import TritonFlashAttention
...
class Attention(nn.Module):
    ...
    def __init__(self, model_args: TransformerModelArgs):
        ...
        is_causal = model_args.attn_mask_type == "causal"
        self.sdpa = TritonFlashAttention(causal=is_causal)
...
class TransformerMoE(nn.Module, ModelProtocol):
    """
    Transformer Module
